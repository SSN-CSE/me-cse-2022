...
1. Define the agile process model (K2)
2. Apply XP agile methods for iterative software development. (K3)
3. Identify the impact of customers on the success of software development process (K3)
4. Evaluate the agile approach for assessing team performance. (K3)
5. Explain the quality assurance in agile methods. (K2)
