...
2. Apply XP agile method for iterative software development. (K3)
3. Determine the impact of customer on software development success. (K3)
4. Evaluate the agile approach for assessing team performance. (K3)
5. Explain the quality assurance in agile methods. (K3)
