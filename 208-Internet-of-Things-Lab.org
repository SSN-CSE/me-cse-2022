...
- Build simple IoT systems using Arduino/Raspberry Pi and sensors (K3).
- Build low cost embedded systems using various communication protocols and web APIs (K3)
- Develop cloud based IoT solutions for real time applications (K6).
