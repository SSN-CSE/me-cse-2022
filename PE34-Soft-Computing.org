* 
:properties:
:author: Dr. P. Mirunalini, Dr. J. Bhuvana and K. Lekshmi
:date: 
:end:
...
- To learn the concepts of genetic algorithms and their applications
...
1. Explain various soft computing techniques (K2)
...
5. Applications of Soft computing to solve problems in varieties of application domains (K3).
